...
public class BoyBand extends Album{ //Class untuk boyband, dimana class ini adalah anak dari class Album.
    public BoyBand(String nama, String lagu1, String lagu2, String lagu3){
        super(nama);
    ...
    public void infoAlbum(){ //Digunakan untuk menampilkan info dari Album" boyband ini
